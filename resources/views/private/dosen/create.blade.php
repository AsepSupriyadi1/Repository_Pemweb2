            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="pb-3">
                        ...
                        <p class="mb-4">Silahkan isi data-data berikut untuk menambahkan data dosen baru.</p>
                    </div>
                    ...
                    <form action="{{ route(name: 'dosen.store') }}" method="POST">
                        @csrf
                        <div class="row gap-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="nidn" placeholder="Contoh: 0123456789" value="{{ old('nidn') }}">
                                    @error('nidn')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama" id="nama" placeholder="Contoh: Dr. Fulan, M.Kom" value="{{ old('nama') }}">
                                    @error('nama')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="gelar_akademik" id="gelar_akademik" placeholder="Contoh: S.Kom, M.Kom" value="{{ old('gelar_akademik') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="Tetap" {{ old('status_dosen') == 'Tetap' ? 'selected' : '' }}>
                                            Tetap
                                        </option>
                                        <option value="Tidak Tetap" {{ old('status_dosen') == 'Tidak Tetap' ? 'selected' : '' }}>
                                            Tidak Tetap
                                        </option>
                                    </select>
