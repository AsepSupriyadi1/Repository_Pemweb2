            ...
            <div class="card shadow mb-4">
                <div class="card-body">
                    <div class="pb-3">
                        ...
                        <p class="mb-4">Silahkan ubah data-data berikut untuk memperbarui data mahasiswa.</p>
                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-user @error('kampus_id') is-invalid @enderror"
                                        ...
                                        @forelse($list_kampus as $item)
                                            <option value="{{ $item->id }}" {{ old('kampus_id') == $item->id || $mahasiswa->kampus->id == $item->id ? 'selected' : '' }}>
                                                {{ $item->nama_kampus }}
                                            </option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input disabled type="text"
                                        ...
                                        id="nim" placeholder="Contoh: 12345678" value="{{ old('nim', $mahasiswa->nim) }}">
                                    @error('nim')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        name="nama" id="nama" placeholder="Contoh: Budi Santoso"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="L" {{ old('jenis_kelamin') == 'L' || $mahasiswa->jenis_kelamin == 'L' ? 'selected' : '' }}>Laki-laki
                                        </option>
                                        <option value="P" {{ old('jenis_kelamin') == 'P' || $mahasiswa->jenis_kelamin == 'P' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="angkatan" id="angkatan" value="{{ old('angkatan', $mahasiswa->angkatan) }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        <option value="Aktif" {{ old('status_mahasiswa') == 'Aktif' || $mahasiswa->status_mahasiswa == 'Aktif' ? 'selected' : '' }}>
                                            Aktif
                                        </option>
                                        <option value="Cuti" {{ old('status_mahasiswa') == 'Cuti' || $mahasiswa->status_mahasiswa == 'Cuti' ? 'selected' : '' }}>
                                            Cuti
                                        </option>
                                        <option value="Lulus" {{ old('status_mahasiswa') == 'Lulus' || $mahasiswa->status_mahasiswa == 'Lulus' ? 'selected' : '' }}>
                                            Lulus
                                        </option>
                                        <option value="DO" {{ old('status_mahasiswa') == 'DO' || $mahasiswa->status_mahasiswa == 'DO' ? 'selected' : '' }}>
                                            Dropout
                                        </option>
                                    </select>
